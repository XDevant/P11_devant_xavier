...
class TestPurchaseView:
    ...
    def test_purchase_sad_not_enough(self, client, mocker, points, places, form):
    ...
    def test_purchase_sad_purchase_out_of_range(self, client, mocker, amount, form):
    ...
    def test_purchase_sad_previous_too_high(self, client, mocker, form):
        mocker.patch('gudlft.filesystem.save_data')
        mocker.patch('gudlft.utils.find_index_by_key_value', mock_index_return)
